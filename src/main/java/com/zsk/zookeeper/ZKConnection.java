...
/**
 * Create by zsk on 2018/8/6
 **/
public class ZKConnection implements Watcher{
    final static Logger log = LoggerFactory.getLogger(ZKConnection.class);
    ...
    public static void main(String[] args) throws Exception{
        ZooKeeper zookeeper = new ZooKeeper(ZK_SERVER_PATH,TIME_OUT,new ZKConnection());
        log.warn("客户端开始连接zk。。。");
    ...
    public void process(WatchedEvent watchedEvent) {
        log.warn("接收到watch通知",watchedEvent.getPath());
    }
}
